...
window.IVS_PART_DEFS = {
  ...
  basket: { label: '바구니', w: 50, h: 30, d: 50 }, // 물컵 모양: 윗지름 5cm·아랫지름 4cm·높이 3cm, 양옆 핀 2개가 구멍 한 칸(2cm) 간격으로 꽂힌다
  marble:   { label: '구슬',     w: 16,  h: 16, d: 16 }, // 지름 1.6cm. 재생하면 이 자리에서 굴러가기 시작하는 구슬
